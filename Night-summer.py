...
def banner():
    load_ico(join(getcwd(),r'Banner.txt'),Fore.GREEN)
    sleep(1)
    print('''\n\n\n\n\n\n\n\n\n\n\n\n''')
    sleep(0.5)
    print(Fore.CYAN + 'que opercion desea hacer:','''
    [0] -> salir
    [1] -> esconder mensaje con LSB < sin cifrar>
    [2] -> leer mensaje con LSB < sin cifrar >
    [3] -> esconder mensaje con LSB < cifrando: Fernet >
    [4] -> leer mensaje con LSB < cifrado: Fernet >
    ''')
    flag = True
    while flag:
        inp = int(input('$>'))
